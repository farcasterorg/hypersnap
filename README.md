...
Clone snapchain and build it. Cargo will fetch the pinned dependency revisions automatically:
```
...
The build uses pinned git dependencies for Malachite and `eth-signature-verifier`, so you do not need to clone those repos separately.
